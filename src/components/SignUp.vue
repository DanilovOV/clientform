<template>
  <form class="form" @submit.prevent="checkForm">
    ...
    <div class="element">
      ...
      >
      <p v-if="$v.form.surname.$dirty && !$v.form.surname.required" class="error">
        Обязательное поле
      </p>
    </div>
    <div class="element">
    ...
    <div class="element">
      ...
      >
      <p v-if="$v.form.birthdate.$dirty && !$v.form.birthdate.required" class="error">
        Обязательное поле
      </p>
    </div>
    <div class="element">
      ...
      <p v-if="$v.form.tel.$dirty && !$v.form.tel.numeric" class="error">
    ...
    <div class="element">
      ...
      <p v-if="$v.form.document.$dirty && !$v.form.document.required" class="error">
        Обязательное поле
      </p>
    </div>
    <div class="element">
    ...
    <div class="element">
      ...
      >
      <p v-if="$v.form.issueDate.$dirty && !$v.form.issueDate.required" class="error">
        Обязательное поле
      </p>
    </div>
    <button class="submitForm" type="submit">Зарегистрироваться</button>
    <p v-if="$v.form.$error" class="error__button">
      Пожалуйста, исправьте ошибки заполнения формы
    </p>
  </form>
</template>
